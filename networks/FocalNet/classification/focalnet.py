...
class FocalModulation(nn.Module):
    def __init__(self, dim, focal_window, focal_level, focal_factor=2, bias=True, proj_drop=0.5, use_postln_in_modulation=False, normalize_modulator=False):
        super().__init__()
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, out_dim, input_resolution, depth,
                 mlp_ratio=4., drop=0.5, drop_path=0.1, norm_layer=nn.LayerNorm, 
